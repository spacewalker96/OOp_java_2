public class Employe {
    ...
    public static void main(String[] args) {
        Employe em = new Employe("Hmiyed","Hassan","quartier hchev zejkbv evv",1996,2020);
        /*em.setNom("Hmiyed");
        em.setPrenom("Hassan");
        em.setAdress("quartier hchev zejkbv evv ");
        em.setAnneeEncours(2020);
        em.setAnneeNaissance(1996);*/
        em.afficherInfosClient();
